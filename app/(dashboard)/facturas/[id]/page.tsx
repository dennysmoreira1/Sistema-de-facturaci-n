        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800">Editar Factura</h1>
                        <p className="text-gray-600">Modifica los detalles de la factura</p>
                    </div>
                </div>
            ...
            {success && (
                <Alert variant="success">
                    ¡Factura actualizada exitosamente! Redirigiendo...
                </Alert>
            )}
